...
class CUSTdataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return self.process( history, responses, label)

    
    def process(self, history, responses, label):
        ...
        for i, response in enumerate(responses):
            ...
            # instance["position_ids"].extend(list(range(0, len(response)))) # response from 0 - 512
